...
import { getAllClubAction, newPlayerAction } from "../../../../redux/slices/adminSlices";
...
function NewManager() {
  ...
  const { loading, appErr, serverErr, allClub, newPlayer } = useSelector(
    (store) => store?.admin
  );
  ...
  const createPlayerSubmitHandler = (e) => {
    e.preventDefault();
    ...
    dispatch(newPlayerAction(myForm));
  };
          ...
          <div className="dashboard">
            ...
            <div className="newProductContainer">
              <form
                ...
                onSubmit={createPlayerSubmitHandler}
              >
                <h1>Create Player</h1>
                <div>
                  <SpellcheckIcon />
